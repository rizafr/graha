...
<script type="text/javascript">
	...
	$('#booked_list').css('height', winHeight-50);
</script>
...
<div class="margin_center" style="width:99%;">
	...
	<div class="frame_tabel_cust radius transparent" id="booked_list" style="float:none; overflow:scroll;">
		...
		<tr bgcolor="#FFFFFF">
			...
			<td rowspan="2" class="header_tabel_cust center"> Harga sblm PPN </td>
			<td rowspan="2" class="header_tabel_cust center"> Tgl Reserve </td>
			<td rowspan="2" class="header_tabel_cust center"> Uang Reserve </td>
