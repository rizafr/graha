...
<div id="frame_data">
	...
	<div class="margin_center" style="width:1000px">
		...
		<div class="tombol_tambah">
			<a href="<?php echo base_url(); ?>report/unit_sold"><input type="button" value="&laquo; Kembali"></a>
		</div>		
		...
		<form name="pemesanan" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>report/unit_sold_edit" onSubmit="return validasi();">
			...
			<table width="500px" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC" style="float:left">				
				...
				?>
					<tr bgcolor="#FFFFFF">
						...
						<td>
							<div class="isi_tabel">
								<input type="text" name="diskon_tanah" id="diskon_tanah" size="5" value="<?php echo $pemesanan->diskon_tanah; ?>" style="text-align:right;" onkeyup="validasi_dikson();" <?php if ($status == "Promo") echo 'onblur="auto();"';?> > %
							</div>
						</td>
					</tr>
					...
					<tr bgcolor="#FFFFFF">
						...
						<td >
							<div class="isi_tabel">
								<input type="text" name="diskon_bangunan" id="diskon_bangunan" size="5" value="<?php echo $pemesanan->diskon_bangunan; ?>" style="text-align:right;" onkeyup="validasi_dikson();" <?php if ($status == "Promo") echo 'onblur="auto();"';?> > %
							</div>
						</td>
					</tr>
				...
				<tr bgcolor="#FFFFFF">
					<td style="height:65px;" valign="top" bgcolor="#999999"><div class="isi_tabel"><strong>Dok. Lainnya</strong></div></td>
					<td valign="top">
