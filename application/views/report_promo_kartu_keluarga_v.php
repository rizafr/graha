...
<script type="text/javascript">	
	...
	function hapus_data_anggota_keluarga(id_anggota_keluarga){
		$.post(base_url+'report/promo_anggota_keluarga_delete/'+id_anggota_keluarga, function(){
...
<div id="frame_data">
	...
	<div class="margin_center" style="width:1000px">
		...
		<div class="tombol_tambah">			
			<a href="<?php echo base_url(); ?>report/promo_form/<?php echo $id_unit."/".$id_kartu_keluarga."/".$id_pemesanan; ?>"><input type="button" value="&laquo; Kembali"></a>
		</div>
		<div class="frame_tabel radius transparent">

			<form name="form_anggota_keluarga" id="form_anggota_keluarga" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>report/promo_anggota_keluarga_add" onSubmit="return validasi();">
					...
					<tr bgcolor="#FFFFFF">
						...
						<td><div class="isi_tabel">
							<select name="status_kawin" id="status_kawin">
								...
								<?php
									$data_status = array("Kawin", "Belum Kawin", "Bercerai");
				...
				<tr bgcolor="#FFFFFF">
					<td colspan="5" align="right">
						<div style="padding:3px;">							
							<a href="<?php echo base_url(); ?>report/promo_preview/<?php echo $id_unit."/".$id_kartu_keluarga."/".$id_pemesanan; ?>"><input type="button" value="Berikutnya &raquo;"></a>
						</div>
					</td>
				</tr>
			</table>
