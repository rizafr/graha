...
<div id="frame_pagging" class="shadow radius">
	...
	<a href="" onClick="javascript:cari(<?php echo $akhir; ?>); return false;">
		<div id="tombol_navigasi">Terakhir</div>
	</a>
	<a href="" onClick="javascript:cari(<?php echo $next; ?>); return false;">
	...
	onClick="javascript:cari(<?php echo $prev; ?>); return false;">
		<div id="tombol_navigasi">Sebelumnya</div>
	</a>
	<a href="<?php echo base_url(); ?>dashboard/user/list_data/0" 
	onClick="javascript:cari(0); return false;">
