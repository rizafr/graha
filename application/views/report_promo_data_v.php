...
<div class="header_data">Report Data Pemesanan Promo</div>
	...
	<table cellspacing="1px" cellpadding="1px" >
		<tr bgcolor="#FFFFFF">
			<td width="160" bgcolor="#0066FF">
				<div class="header_tabel_cari" style="height: 100%;">
					<span class="header_tabel_cari" style="height: 100%;">
						<input type="radio" name="filter" value="nomor_pemesanan" <?php if($filter == "nomor_pemesanan"){ echo "checked"; } ?>>
					</span>Nomor Pemesanan
				</div>
			</td>
			<td>
				<div class="isi_tabel">
		...
		<tr bgcolor="#FFFFFF">
			<td width="160" bgcolor="#0066FF">
				<div class="header_tabel_cari" style="height: 100%;">
					<span class="header_tabel_cari" style="height: 100%;">
						<input type="radio" name="filter" value="cluster" <?php if($filter == "cluster"){ echo "checked"; } ?>>
					</span>Nama Cluster
				</div>
			</td>
			<td>
...
<div class="frame_tabel_cust radius transparent" style="float:none;">
	<table width="100%" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC">
		<tr bgcolor="#FFFFFF">
			...
			<td colspan="4" width="70px" class="header_tabel_cust"><div>&nbsp;</div></td>
		</tr>
		...
		<tr class="hover">
			...
			<td align="center">
				<div class="isi_tabel" id="status_verify_<?php echo $data_pemesanan->id_pemesanan; ?>">
				
					<font color="green"><?php echo $data_pemesanan->status_verify; ?></font>
			...
			if ($this->access_lib->_if("adm,mgr,ksr"))
			{
				?>
				<td align="center">
					<a href="javascript:void(0);" title="Verify" onClick="javascript:verify(<?php echo $data_pemesanan->id_pemesanan; ?>); return false;">
						<div class="isi_tabel">
			...
			<td align="center">
				<a href="<?php echo base_url(); ?>report/promo_detail/<?php echo $data_pemesanan->id_unit."/".$data_pemesanan->id_kartu_keluarga."/".$data_pemesanan->id_pemesanan; ?>" title="Tampilkan" >
					<div class="isi_tabel">
			...
			{
				if($data_pemesanan->id_user == $this->session->userdata('id_user'))
				{
					?>
					<td align="center">
						<a href="<?php echo base_url(); ?>report/promo_form/<?php echo $data_pemesanan->id_unit."/".$data_pemesanan->id_kartu_keluarga."/".$data_pemesanan->id_pemesanan; ?>" title="Ubah">
							<div class="isi_tabel">
...
<div id="frame_pagging" class="shadow radius">
	...
	<a href="javascript:void(0);" onClick="javascript:list(<?php echo $akhir; ?>); return false;">
		<div id="tombol_navigasi">Terakhir</div>
	</a>
	<a href="javascript:void(0);" onClick="javascript:list(<?php echo $next; ?>); return false;">
	...
	<a href="javascript:void(0);" onClick="javascript:list(<?php echo $prev; ?>); return false;">
		<div id="tombol_navigasi">Sebelumnya</div>
	</a>
	<a href="javascript:void(0);" onClick="javascript:list(0); return false;">
