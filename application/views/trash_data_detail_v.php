...
<div id="frame_data">
	...
	<div class="margin_center" style="width:1000px">
		...
		<div class="tombol_tambah">
			<a href="<?php echo base_url(); ?>trash_data"><input type="button" value="&laquo; Kembali"></a>
		</div>
		...
		<div class="frame_tabel radius transparent" style="width:1000px" id="td-height">		
			<table width="500px" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC" style="float:left">
				<tr bgcolor="#FFFFFF">
					<td width="200" bgcolor="#999999"><div class="isi_tabel"><strong>NUP</strong></div></td>
					<td>
						<div class="isi_tabel">
			...
			<table width="1000px" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC">
				<tr bgcolor="#FFFFFF">
					<td colspan="4" valign="top" bgcolor="#FFFFFF">
						<div class="isi_tabel" style="color:#F00;">
							Dihapus oleh : <?php echo $user_delete->nama_lengkap; ?> (<?php echo ubah_format_tanggal($pemesanan->delete_time, 'H:i:s'); ?>)
						</div>
					</td>
				</tr>	
			</table>
