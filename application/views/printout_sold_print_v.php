...
$filename = "Laporan Sold $jenis_pemesanan $kategori $team $nama_sales $file_tanggal";
...
if ($type == "bulanan")
{	
	echo "<h3>LAPORAN PENJUALAN $jenis_pemesanan $kategori $team $nama_sales BULAN $mm $yy - GRAHA RAYA</h3>";
}
else
{
	echo "<h3>LAPORAN PENJUALAN $jenis_pemesanan $kategori $team $nama_sales TANGGAL $dd $mm $yy - GRAHA RAYA</h3>";
}
?>
