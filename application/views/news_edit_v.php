...
<div id="frame_data">
	<div class="margin_center" style="width:1000px">		
		<div class="header_data">Ubah Data</div>
		...
		<input name="id_news" type="hidden" id="id_news" size="50" value="<?php echo $data_news->id_news; ?>">
		<div class="frame_tabel radius transparent">
			<table width="1000px" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC">
				<tr bgcolor="#FFFFFF">
					...
					<td>
						<div class="isi_tabel">
							<input name="judul" type="text" id="judul" size="110" value="<?php echo $data_news->judul; ?>">
						</div>
					</td>
				</tr>
				<tr bgcolor="#FFFFFF">
				...
				<tr bgcolor="#FFFFFF">
					...
					<td>
						<div class="isi_tabel" id="sample">
							<textarea name="deskripsi" id="deskripsi" cols="150" rows="20"><?php echo $data_news->deskripsi; ?></textarea>
						</div>
					</td>
				</tr>
				<tr bgcolor="#FFFFFF">
					...
					<td>
						<div class="isi_tabel">
							<select name="status" id="status">
								<option value="Aktif" <?php if($data_news->status == "Aktif") echo 'selected="selected"';?> >Aktif</option>
								<option value="Tidak Aktif" <?php if($data_news->status == "Tidak Aktif") echo 'selected="selected"';?> >Tidak Aktif</option>
							</select>
						</div>
					</td>
				</tr>
