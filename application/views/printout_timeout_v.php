	...
	<div class="frame_tabel_cust radius transparent" id="sold_list" style="float:none; overflow:scroll;">
		<table style="white-space:nowrap; min-width:100%;" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC">
			...
			<tr bgcolor="#FFFFFF">
				...
				<td rowspan="2" class="header_tabel_cust center"> Status Transaksi </td>
				<td rowspan="2" class="header_tabel_cust center"> Tgl Pemesanan </td>
				<td rowspan="2" class="header_tabel_cust center"> Tgl TJ </td>
				<td rowspan="2" class="header_tabel_cust center"> Timeout </td>
				<td rowspan="2" class="header_tabel_cust center"> Tgl Exp </td>
				...
				<td rowspan="2" class="header_tabel_cust center"> Booking Fee (RP) </td>
			...
			foreach($lap as $b)
			{
				...
				{
					$tanggal_status = $b->tanggal_pemesanan;
				}
				elseif ($b->status_pemesanan == "Tanda Jadi")
				{
					$tanggal_status = $b->tanggal_tanda_jadi;
				}
				...
				<tr class="hover">
					...
					<td class="isi_tabel"> <?php ubah_format_tanggal($b->tanggal_pemesanan, "H:i:s"); ?> </td>
					<td class="isi_tabel"> <?php ubah_format_tanggal($b->tanggal_tanda_jadi, "H:i:s"); ?> </td>
					<td class="isi_tabel right"> <?php echo dhm($b->timeout, "dhm"); ?> </td>
					<td class="isi_tabel"> <?php exp_order($b->timeout, $tanggal_status); ?> </td>
					...
					<td class="isi_tabel right"> <?php echo number_format($b->booking_fee, 0); ?> </td>
				...
				$sum_booking_fee += $b->booking_fee;
				$sum_tanda_jadi += $b->tanda_jadi;
			}
			?>
			
			<tr bgcolor="#B0B0B0">
				<td class="header_tabel_cust center" colspan="11"> Total </td>
				...
				<td class="isi_tabel"></td>
				<td class="isi_tabel right bold"> <?php echo number_format($sum_booking_fee, 0); ?> </td>
