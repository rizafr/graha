...
<div id="frame_data">
	...
	<div class="margin_center" style="width:1000px">
		...
		<div class="tombol_tambah">
			<a href="<?php echo base_url(); ?>report/unit_sold_anggota_keluarga/<?php echo $id_unit."/".$id_kartu_keluarga."/".$id_pemesanan; ?>"><input type="button" value="&laquo; Kembali"></a>
		</div>
				...
				<tr bgcolor="#FFFFFF">
					<td colspan="5" align="right">
						<div style="padding:3px;">
							...
							<a href="<?php echo base_url(); ?>report/unit_sold/0"><input type="button" value="Selesai &#10003;"></a>
						</div>
					</td>
				</tr>
			</table>
