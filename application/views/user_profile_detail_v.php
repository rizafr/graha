...
<div class="margin_left" style="width:600px">
	<div class="header_data">Profile User</div>
	<div class="tombol_tambah">
		<a href="" onClick="javascript:profile_form(); return false;"><input type="button" value="Ubah"></a>
	</div>
		...
		<table width="600px" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC">
			...
			if ($user->level == "Sales")
			{
				...
				<tr bgcolor="#FFFFFF">
					...
					<td><div class="isi_tabel"><?php echo $agent->team; ?></div></td>
				</tr>
				<tr bgcolor="#FFFFFF">
					<td bgcolor="#999999"><div class="isi_tabel"><strong>Sales Manager</strong></div></td>
					<td><div class="isi_tabel"><?php echo $agent->sales_manager; ?></div></td>
				</tr>
				<?php
			}
			?>	
