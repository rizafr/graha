...
<div id="frame_data">
	...
	<div class="margin_center" style="width:1000px">
		...
		<div class="tombol_tambah">
			<a href="<?php echo base_url(); ?>booking/form_kartu_keluarga/<?php echo $id_siteplan."/".$id_unit."/".$id_kartu_keluarga."/".$id_pemesanan; ?>"><input type="button" value="&laquo; Kembali"></a>
		</div>
				...
				<tr bgcolor="#FFFFFF">
					...
					<td>
						<div class="isi_tabel">
							...
							{
								?>
								<a data-lightbox="image-1" href="<?php echo base_url(); ?>files/dokumen_user/<?php echo $pemesanan->doc_kartu_keluarga; ?>" target="_blank">KK</a>
								<?php		
							}
							?>
						</div>
				...
				<tr bgcolor="#FFFFFF">
					...
					<td>
						<div class="isi_tabel">
							...
							{
								?>
								<a data-lightbox="image-1" href="<?php echo base_url(); ?>files/dokumen_user/<?php echo $pemesanan->doc_akta_nikah; ?>" target="_blank">AN</a>
								<?php		
							}
							?>
						</div>
				...
				<tr bgcolor="#FFFFFF">
					<td colspan="5" align="right">
						<div style="padding:3px;">
							<a href="<?php echo base_url(); ?>booking/print_form/<?php echo $id_siteplan."/".$id_unit."/".$id_kartu_keluarga."/".$id_pemesanan; ?>" target="_blank"><input type="button" value="Print &#9113;"></a>
							<?php
							if($status == "Promo")
							{		
								?>
								<a href="<?php echo base_url(); ?>booking/promo"><input type="button" value="Selesai &#10003;"></a>
								<?php
							}
							else
							{
								?>
								<a href="<?php echo base_url(); ?>booking"><input type="button" value="Selesai &#10003;"></a>
								<?php
							}
							?>
						</div>
