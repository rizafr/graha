	...
	<div class="frame_tabel_cust radius transparent" id="sold_list" style="float:none; overflow:scroll;">
		<table style="white-space:nowrap; min-width:100%;" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC">
			...
			<tr bgcolor="#FFFFFF">
				...
				<td rowspan="2" class="header_tabel_cust center"> Status Verify </td>
				<td rowspan="2" class="header_tabel_cust center"> Tgl Pemesanan </td>
				<td rowspan="2" class="header_tabel_cust center"> Tgl TJ </td>
				<td rowspan="2" class="header_tabel_cust center"> Tgl Dihapus </td>
				<td rowspan="2" class="header_tabel_cust center"> Dihapus Oleh </td>
			...
			foreach($lap as $b)
			{
				...
				<tr class="hover">
					...
					<td class="isi_tabel center"> <font color="green"><?php echo $b->status_verify; ?></font> </td>
					<td class="isi_tabel"> <?php echo $b->tanggal_pemesanan; ?> </td>
					<td class="isi_tabel"> <?php echo $b->tanggal_tanda_jadi; ?> </td>
					<td class="isi_tabel"> <?php ubah_format_tanggal($b->delete_time, "H:i:s"); ?> </td>
					<td class="isi_tabel"> <?php echo $b->delete_by; ?> </td>
			...
			<tr bgcolor="#B0B0B0">
				<td class="header_tabel_cust center" colspan="12"> Total </td>
