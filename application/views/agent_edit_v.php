	...
	<div class="header_data">Ubah Data Team Sales</div>
	...
	<div class="frame_tabel radius transparent">
		...
		<table width="550px" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC">
			<tr bgcolor="#FFFFFF">
				...
				<td width="350px">
					<div class="isi_tabel">
						<input name="team" type="text" id="team" size="50" value="<?php echo $data_agent->team; ?>">
					</div>
				</td>
			</tr>	
				...
				<td>
					<div class="isi_tabel">
						<select name="id_sm" id="id_sm">
							...
							{
								$sel = '';
								if($data_agent->id_sm == $data_user->id_user)
								{
									$sel = 'selected="selected"';
								}
								?>
								<option value="<?php echo $data_user->id_user; ?>" <?php echo $sel; ?>> <?php echo $data_user->nama_lengkap; ?> </option>
								<?php
							}
							?>
						</select>
