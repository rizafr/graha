...
<div id="frame_data">
	...
	<div class="margin_center" style="width:1000px">
		...
		<div class="tombol_tambah">
			<a href="<?php echo base_url(); ?>report/promo"><input type="button" value="&laquo; Kembali"></a>
		</div>
		...
		<form action="<?php echo base_url(); ?>report/promo_edit" method="post" enctype="multipart/form-data" name="pemesanan" onSubmit="return validasi();">
