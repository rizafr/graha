...
<div class="header_data">Report Data Pemesanan Regular</div>
		...
		<tr class="hover">
			...
			if ($this->session->userdata('level') == "Sales")
			{
				if($data_pemesanan->id_user == $this->session->userdata('id_user'))
				{
					?>
					<td align="center">
						<a href="<?php echo base_url(); ?>report/regular_form/<?php echo $data_pemesanan->id_unit."/".$data_pemesanan->id_kartu_keluarga."/".$data_pemesanan->id_pemesanan; ?>" title="Ubah">
							<div class="isi_tabel">
...
<div id="frame_pagging" class="shadow radius">
	...
	<a href="javascript:void(0);" onClick="javascript:list_filter(<?php echo $akhir; ?>); return false;">
		<div id="tombol_navigasi">Terakhir</div>
	</a>
	<a href="javascript:void(0);" onClick="javascript:list_filter(<?php echo $next; ?>); return false;">
	...
	<a href="javascript:void(0);" onClick="javascript:list_filter(<?php echo $prev; ?>); return false;">
...
<div id="frame_pagging" class="shadow radius">
	...
	<a href="<?php echo base_url(); ?>dashboard/user/list_data/<?php echo $akhir; ?>" onClick="javascript:list(<?php echo $akhir; ?>); return false;">
		<div id="tombol_navigasi">Terakhir</div>
	</a>
	<a href="<?php echo base_url(); ?>dashboard/user/list_data/<?php echo $next; ?>" onClick="javascript:list(<?php echo $next; ?>); return false;">
		<div id="tombol_navigasi">Berikutnya</div>
	</a>
