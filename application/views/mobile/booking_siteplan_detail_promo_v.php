...
<div id="frame_data">		
	<div class="margin_center" style="width:1000px; margin-bottom:20px;">
		...
		<div class="tombol_tambah">	
			<a href="<?php echo base_url(); ?>booking/promo">
	...
	<div id="frame-sp">
		...
		foreach($unit as $data_unit)
		{
			...
			$color = '';
				...
				{
					$color = 'data-maphilight=\'{"fillColor":"FF00FF"}\' href="'.base_url().'booking/form_pemesanan/add/'.$data_siteplan->id_siteplan.'/'.$data_unit->id_unit.'"';
				}
