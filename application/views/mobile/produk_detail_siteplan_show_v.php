...
<div class="margin_center" style="width:1000px; margin-bottom:20px;">
	...
	<div id="keterangan-siteplan">
		<div style="float:left; width:150px;"><span style="display:inline-block; width:50px; height:10px; background:#0099CC;"></span><span> : Booked</span></div>
		<div style="float:right; width:150px;"><span style="display:inline-block; width:50px; height:10px; background:#00DD00;"></span><span> : Marketable</span></div>
		<div style="float:left; width:150px;"><span style="display:inline-block; width:50px; height:10px; background:#FF3300;"></span><span> : Sold</span></div>
		<div style="float:right; width:150px;"><span style="display:inline-block; width:50px; height:10px; background:#FF00FF;"></span><span> : Promo</span></div>
	</div>
