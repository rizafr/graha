...
$filename = "Laporan Timeout $jenis_pemesanan $kategori $team $nama_sales $file_tanggal";
...
echo "<h3>LAPORAN PEMESANAN TIMEOUT $jenis_pemesanan $kategori $team $nama_sales TANGGAL $dd $mm $yy - GRAHA RAYA</h3>";
...
foreach($lap as $b)
{
	...
	<tr>
		...
		<td> <?php ubah_format_tanggal($b->tanggal_pemesanan, "H:i:s"); ?> </td>
		<td> <?php ubah_format_tanggal($b->tanggal_tanda_jadi, "H:i:s"); ?> </td>
		<td align="right"> <?php echo dhm($b->timeout, "dhm"); ?> </td>
		<td> <?php exp_order($b->timeout, $tanggal_status); ?> </td>
