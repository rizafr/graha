...
<div id="frame_data">
	<div class="margin_left" style="width:910px">		
		...
		<div class="tombol_tambah">
			<a href="<?php echo base_url(); ?>type/index/<?php echo $id_cluster; ?>"><input type="button" value="&laquo; Kembali"></a>
		</div>
		...
		<div class="frame_tabel radius transparent">
			<table width="700px" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC">
				<tr bgcolor="#FFFFFF">
					...
					<td>
						<div class="isi_tabel">
							<input name="nama_type" type="text" id="nama_type" size="50" value="<?php echo set_value('nama_type'); ?>">
						</div>
					</td>
				</tr>
				<tr bgcolor="#FFFFFF">
					...
					<td>
						<div class="isi_tabel" id="sample">
							<textarea name="deskripsi" id="deskripsi" cols="70" rows="15"><?php echo set_value('deskripsi'); ?></textarea>
						</div>
					</td>
				</tr>
				<tr bgcolor="#FFFFFF">
		...
		<div class="frame_tabel radius transparent" style="margin-left:30px;">
			<table width="170px" cellspacing="1px" cellpadding="2px" bgcolor="#CCCCCC">
				<tr bgcolor="#FFFFFF">
					...
					<td>
						<div class="isi_tabel">
							<input name="kode_blok[]" type="text" size="5" value="" style="text-align:center;">
						</div>
					</td>
				</tr>
				
				<tr id="tr_add"><input type="hidden" name="nblok" id="nblok" value="1"></tr>
